...
export const alt = "글자수 세기 · Character Counter - CharCat";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <p style={{ fontSize: 26, color: "#6b7280", margin: 0, lineHeight: 1.5 }}>
            공백 포함/제외 · 단어수 · 문장수 · 바이트 실시간 계산
          </p>
        </div>

        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <span style={{ fontSize: 20, color: "#7c3aed", fontWeight: 600 }}>charcat.cyb-labs.com/char-count</span>
