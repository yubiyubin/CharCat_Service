...
export const styles = {
  ...
  textareaContainer: `${commonBox} flex flex-col focus-within:ring-2 focus-within:ring-primary/30`,
  flexContainer:
  ...
  noneBorderTextarea:
    "w-full h-80 overflow-y-auto flex-1 p-6 mt-2 border-none focus:outline-none rounded-lg text-text-primary/70 resize-none",
