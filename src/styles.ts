...
export const styles = {
  ...
  textareaContainer: `${commonBox} min-h-64 h-auto max-h-[400px] overflow-y-auto flex flex-col focus-within:ring-2 focus-within:ring-primary/30`,
  flexContainer:
  ...
  textarea: `${commonBox} p-4 h-64 resize-none focus:outline-none focus:ring-2 focus:ring-primary/30`,
  noneBorderTextarea:
    "w-full h-auto flex-1 p-4 mt-2 border-none focus:outline-none rounded-lg text-text-primary/70",
  resultTextarea: `${commonBox} min-h-64 h-auto max-h-100 p-4 bg-surface-muted/80 border-none pt-10 flex flex-col justify-between`,
